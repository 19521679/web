...
export default class EditModal extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      tenkhachhang: this.props.customer.tenkhachhang,
      email: this.props.customer.email,
      sodienthoai: this.props.customer.sodienthoai,
      diachi: this.props.customer.diachi,
      cccd: this.props.customer.cccd,
      ngaysinh: new Date(this.props.customer.ngaysinh),
      image: undefined,
      loaikhachhang: this.props.customer.loaikhachhang,
      progress: 0,
    };
  }
  submitHandler = () => {
    const fd = new FormData();
    fd.append("makhachhang", this.state.makhachhang);
    ...
    customerApi
      .editCustomer(fd, this.setProgress.bind(this))
      .then((success) => {
